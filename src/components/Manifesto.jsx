...
const Manifesto = () => {
  ...
  return (
    <section
      ref={ref}
      className="relative py-32 px-6 md:px-20 bg-[#030303] border-t border-white/5 overflow-hidden z-20"
    >
      {/* THREADS BACKGROUND */}
      ...
      {/* Subtle Accent Line */}
      <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#46cef6]/40 to-transparent z-10" />
