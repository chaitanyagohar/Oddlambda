...
const TrustSection = () => {
  return (
    // 1. Wrapper Div: clipPath fixed element ko sirf isi box me dikhata hai
    <div
      className="relative w-full"
      style={{ clipPath: "inset(0 0 0 0)" }}
    >
      {/* 2. Fixed Background Layer (Video + Blobs + Overlay) */}
      {/* Isko humne fixed kiya hai taaki ye scroll na ho, bas piche dikhe */}
      <div className="fixed inset-0 h-full w-full -z-10">
        ...
        {/* Floating Blobs (Fixed with video) */}
      ...
      {/* bg-transparent zaroori hai taaki piche ka fixed video dikhe */}
      <section className="relative py-44 px-6 bg-transparent overflow-hidden font-[Inter]">
